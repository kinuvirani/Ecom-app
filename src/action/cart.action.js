...
export const updateProductQuantity = (pid, qty) => {
  return (dispatch) => {
    api
      .put(`product/update/quantity/${pid}/${qty}`)
      .then((response) => {
        dispatch({
